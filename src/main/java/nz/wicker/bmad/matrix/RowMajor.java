...
import nz.wicker.bmad.general.layout.*;
...
public class RowMajor<X> {
	...
	public RowMajor(int h, int w, final X defaultValue) {
		this(h, w, nz.wicker.bmad.general.Package.<Tuple<Integer, Integer>, X>constant(defaultValue));
	}
	...
	public String toString() {
		...
		*/
		...
		return toString(nz.wicker.bmad.general.Package.<Integer, Padding>constant(new Center()), 
						nz.wicker.bmad.general.Package.<Integer, Padding>constant(new Center()));
	}
